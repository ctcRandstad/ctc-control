...
@Component({
  selector: 'app-absentismo-ant',
  templateUrl: './absentismo-ant.component.html',
  styleUrls: ['./absentismo-ant.component.css']
})
export class AbsentismoAntComponent implements OnInit {
