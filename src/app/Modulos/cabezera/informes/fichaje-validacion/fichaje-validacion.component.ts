...
@Component({
  selector: 'app-fichaje-validacion',
  templateUrl: './fichaje-validacion.component.html',
  styleUrls: ['./fichaje-validacion.component.css']
})
export class FichajeValidacionComponent implements OnInit {
