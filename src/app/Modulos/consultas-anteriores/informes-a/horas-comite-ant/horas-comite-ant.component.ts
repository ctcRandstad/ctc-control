...
@Component({
  selector: 'app-horas-comite-ant',
  templateUrl: './horas-comite-ant.component.html',
  styleUrls: ['./horas-comite-ant.component.css']
})
export class HorasComiteAntComponent implements OnInit {
